...
class AlertViewController: UIViewController {
    ...
    func styleViews(){
        ...
        newRegistrationButtonOutlet.backgroundColor = device != DeviceType.macCatalyst ? Colors.blueDefault : .clear
        newRegistrationButtonOutlet.layer.cornerRadius = CornerRadius.mediumSmall
        loginButtonOutlet.backgroundColor = device != DeviceType.macCatalyst ? Colors.blueDefault : .clear
